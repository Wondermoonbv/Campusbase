...
export const mockEventPrograms: EventProgram[] = [
  ...
  { event_id: "1", program_id: "2" },
  { event_id: "2", program_id: "3" },
  { event_id: "3", program_id: "2" },
  { event_id: "3", program_id: "5" },
  { event_id: "4", program_id: "5" },
  { event_id: "5", program_id: "4" },
];
...
export const mockTasks: Task[] = [
  ...
  { id: "t7", title: "Budget aanvraag ingenieursbeurs Brussel", description: "Budget voorstel indienen bij management.", school_id: null, event_id: "7", assigned_to: "Eline ten Cate", due_date: "2026-04-05", priority: "normaal", status: "in behandeling", created_at: "2026-03-17" },

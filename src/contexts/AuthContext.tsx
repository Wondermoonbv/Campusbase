...
const DEFAULT_USERS: AppUser[] = [
  ...
  { id: "u5", firstName: "Eline", lastName: "ten Cate", name: "Eline ten Cate", email: "eline.tencate@elia.be", role: "admin", notifications: { ...DEFAULT_NOTIFICATIONS } },, role: "admin", notifications: { ...DEFAULT_NOTIFICATIONS } },
];
